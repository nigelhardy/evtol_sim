...
namespace evtol
{
    ...
    struct AircraftFrameData
    {
        ...
        std::atomic<double> time_remaining{0.0};        // Time left in current activity
        std::atomic<double> current_flight_time{0.0};   // Current flight duration
        ...
        AircraftFrameData(AircraftFrameData&& other) noexcept 
            ...
            , time_remaining(other.time_remaining.load())
            , current_flight_time(other.current_flight_time.load())
        ...
        AircraftFrameData& operator=(AircraftFrameData&& other) noexcept
        {
            if (this != &other) {
                ...
                time_remaining.store(other.time_remaining.load());
                current_flight_time.store(other.current_flight_time.load());
    ...
    public:
        ...
        /**
         * Process a frame update for this aircraft
         * @param delta_time Time elapsed since last frame
         * @return True if state changed
         */
        bool update_frame(double delta_time);
